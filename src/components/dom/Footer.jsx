  ...
  return (
    <section ref={footerRef} className={clsx(styles.root, 'layout-grid-inner')} role="contentinfo">
        ...
        <AppearTitle isFooter>
          ...
          <div>
            <div className={styles.link}>
              <Link aria-label="Send email" scroll={false} href="mailto:jefyjery10@gmail.com">
                <h4 className={clsx(styles.email, 'h4')}>jefyjery10@gmail.com</h4>
              </Link>
      ...
      <div className={styles.middleContainer} style={{ gridColumn: '1 / 9' }}>
        <AppearTitle isFooter>
          <div className="p-x">Based in Tamil Nadu, India</div>
