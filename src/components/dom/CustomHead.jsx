...
const getSchema = () => ({
  ...
  sameAs: ['https://www.linkedin.com/in/jeffreyhasan', 'https://github.com/jeffreyhasan10', 'https://twitter.com/jeffreyhasan', 'https://www.instagram.com/jeffx_.17', 'https://medium.com/@jefyjery10'],
  alumniOf: [
